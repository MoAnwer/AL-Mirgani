<x-header title="حذف كشف راتب {{ $payroll->employee->name }}"/>
    <x-Container>
        ...
        <div class="authentication-wrapper authentication-basic container-p-y">
            ...
            <div class="card px-sm-6 px-0">
                ...
                <form id="formAuthentication" class="mb-6" action="{{ route('payroll.destroy', $payroll) }}" method="POST">
                    @method('DELETE')
                    @csrf
                    <h3 class="m-5">@lang('app.delete_confirm_message', ['attribute' =>  "كشف راتب " . $payroll->employee->full_name . " لشهر " . $payroll->month])</h3>
