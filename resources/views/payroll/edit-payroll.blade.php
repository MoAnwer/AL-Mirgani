                    ...
                    <form action="{{ route('payroll.update', $payroll->id) }}" method="POST">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" min="0"  name="month" id="month" class="form-control @error('month') is-invalid @enderror" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" min="0"  name="year" id="year" class="form-control @error('year') is-invalid @enderror" 
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" min="0"  name="basic_salary_snapshot" id="basic_salary_snapshot" class="form-control @error('basic_salary_snapshot') is-invalid @enderror" 
                            ...
                            <div class="col-md-6 my-4">
                                ...
                                <div class="input-group">
                                    <input type="number" min="0"  class="@error('transaction_id') is-invalid @enderror form-control" name="transaction_id" placeholder="{{ $payroll->transaction_id }}" />
                                </div>
