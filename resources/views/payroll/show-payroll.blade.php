<x-header title="كشف الراتب المفصّل" />
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                ...
                                <div class="text-center mb-5 card pt-6 pb-3">
                                    <h2 class="display-5 fw-bold text-primary mb-3">كشف الراتب المفصّل</h2>
                                    <p class="lead text-muted fs-5">الفترة المالية: <span class="fw-bold text-dark">{{ $payroll->month }}/{{ $payroll->year }}</span></p>
                                </div>
                                ...
                                <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                                    ...
                                    <div class="card-body p-5">
                                        <div class="row g-5"> 
                                            ...
                                            <div class="col-md-6 pe-md-4 border-end border-light"> 
                                                <h5 class="text-success border-bottom pb-3 mb-4 fw-bold"><i class='bx bxs-up-arrow-circle me-2'></i> المستحقات</h5>
                                                <table class="table table-sm table-borderless mb-0">
                                                    <tbody>
                                                        <tr>
                                                            <td class="text-muted ps-0">الراتب الأساسي</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if($payroll->payment_status !== \App\Enums\PaymentStatusEnum::PAID->value)
                                                                ...
                                                                <td class="text-end ps-0" style="width: 5%;">
                                                                    ...
                                                                    data-bs-toggle="tooltip" data-bs-placement="top" title="تعديل البند">
                                                    ...
                                                    <tfoot class="border-top mt-4 pt-3"> 
                                                        <tr class="fw-bold fs-5 text-primary">
                                                            <td class="ps-0 pt-3">إجمالي المستحقات</td>
                                            ...
                                            <div class="col-md-6 ps-md-4">
                                                <h5 class="text-danger border-bottom pb-3 mb-4 fw-bold"><i class='bx bxs-down-arrow-circle me-2'></i>الاستقطاعات</h5>
                                                <table class="table table-sm table-borderless mb-0">
                                                    <tbody>
                                                    ...
                                                    <tfoot class="border-top mt-4 pt-3"> 
                                                        <tr class="fw-bold fs-5 text-danger">
                                                            <td class="ps-0 pt-3">إجمالي الاستقطاعات</td>
                                    ...
                                    <div class="card-footer border-top p-4 d-flex justify-content-start gap-2">
                                        <a href="{{ route('payroll.index') }}" class="btn btn-outline-secondary btn-lg  px-4">
                                            <i class='bx bx-list-ul me-2'></i> العودة للقائمة
                                        </a>
                                        ...
                                        <a href="{{ route('payroll.edit', $payroll->id) }}" class="btn btn-warning btn-lg  px-4">
                                            <i class="bx bx-edit me-2"></i> تعديل الملخص
                                        </a>
                                        @endif
