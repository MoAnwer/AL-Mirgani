                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                                ...
                                <div class="card-body p-5">
                                            ...
                                            <table class="table table-sm table-borderless mb-0">
                                                <tbody>
                                                   <tr class="border-bottom">
                                                    ...
                                                    <tr class="border-bottom">
                                                        <td class="text-muted ps-0">{{ $detail->item?->name }} <span class="ps-3">({{ $detail->date }})</span> </td>
                                                        <td class="text-end text-success fw-medium">+ {{ number_format($detail->amount) }}</td>
                                                        @if(!$payroll->isPaid())
                                                            <td class="text-end p-1" style="width: 1%;">
                                                                <a href="{{ route('payroll.details.edit', ['payroll' => $payroll->id, 'detail' => $detail->id]) }}" class="text-info opacity-75 edit-icon-hover" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('app.edit') }}">
                                                                    <i class='bx bx-edit-alt fs-5'></i>
                                                                </a>
                                                                
                                                            </td>
                                                            <td class="text-end p-1" style="width: 1%;">
                                                                <a href="{{ route('payroll.details.delete', ['payroll' => $payroll->id, 'detail' => $detail->id]) }}" class="text-danger opacity-75 delete-icon-hover" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('app.delete') }}">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        @if(!$payroll->isPaid())
                                                            ...
                                                            <td class="text-end p-1" style="width: 1%;">
                                                                <a href="{{ route('payroll.details.delete', ['payroll' => $payroll, 'detail' => $detail]) }}" class="text-danger opacity-75 delete-icon-hover" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ __('app.delete') }}">
                                                                    <i class='bx bx-trash-alt fs-5'></i>
                                                                </a>
                                                            </td>
                                                        @endif
                                    ...
                                    <div class="mt-10 p-5 bg-gradient-success text-white rounded-3 text-center shadow">
