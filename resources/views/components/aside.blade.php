<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <li class="menu-item">
        ...
        <div class="text-truncate" data-i18n="Layouts">التصميم</div>
        </a>
    ...
    <li class="menu-item">
        ...
        <div class="text-truncate" data-i18n="Front Pages">الصفحات</div>
    ...
    <li class="menu-item">
        ...
        <div class="text-truncate" data-i18n="Account Settings">اعدادت الحسابات</div>
        </a>
        <ul class="menu-sub">
        <li class="menu-item">
        ...
        <li class="menu-item">
            ...
            <div class="text-truncate" data-i18n="Connections">الحسابات المتصلة</div>
            </a>
        </li>
        </ul>
    </li>
    <li class="menu-item">
        ...
        <div class="text-truncate" data-i18n="Authentications">التوثيق</div>
        </a>
        <ul class="menu-sub">
        <li class="menu-item">
            <a href="auth-login-basic.html" class="menu-link" target="_blank">
            <div class="text-truncate" data-i18n="Basic">تسجيل الدخول</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="auth-register-basic.html" class="menu-link" target="_blank">
            <div class="text-truncate" data-i18n="Basic">حساب جديد</div>
            </a>
        </li>
        <li class="menu-item">
