                    ...
                    <div class="justify-content-center card p-10">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <div id="notification-{{ $notification->id }}" class="notification-card  p-3 shadow-sm border-{{ $color }}" style="--bs-primary: {{ $color === 'primary' ? '#0d6efd' : ($color === 'success' ? '#198754' : ($color === 'danger' ? '#dc3545' : '#ffc107')) }};">
                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        ...
                                        <div class="flex-shrink-0">
                                            <button data-id="{{ $notification->id }}" class="mark-as-read-btn bg-white border-0 text-secondary" title="{{ __('app.mark_as_read') }}">
