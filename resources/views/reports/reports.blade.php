            ...
            <x-container>
                <div class="dashboard-container">
                    ...
                    <x-cards.cards-container>
                        <x-cards.card link="{{ route('accounts') }}" icon="bx bx-book-open" title=" كشف الحساب " description=""/>
                        <x-cards.card link="{{ route('arrears.all') }}" icon="bx bx-money" title=" الأقساط المتأخرة" description="نظرة عامة عن متاخرات الاقساط"/>
                        <x-cards.card link="{{ route('revenues') }}" icon='bx bxs-bar-chart-alt-2' title="ايرادات حسب الصف" description="ايرادات حسب الصف للمدرسة الابتدائية"/>
