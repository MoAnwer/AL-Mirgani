                ...
                <x-Container>
                                    ...
                                    <div class="row p-3">
                                        ...
                                        <div class="col-4">
                                            <div class="input-group" title="{{ __('app.payment_date') }}">
                                                <input type="date" class="form-control" name="date" max="{{ date('Y-m-d') }}" value="{{ request()->query('date') }}" onchange="this.form.submit()" />
                                            </div>
                                        </div>
                    ...
                    <div class="card">
                        <h4 class="card-header mb-0 pb-0">
                            ...
                            @lang('app.earning') @lang('app.school') {{ array_keys($schools->filter(fn($id, $name) => $id == request()->query('school_id') ? $name : null)->toArray())[0]}}
                            @endempty
